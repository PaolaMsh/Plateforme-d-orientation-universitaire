...
// Phase 2 sections configuration
...
const Test = () => {
  ...
  const resolveProgress = async (token, assessmentIdParam) => {
    try {
      ...
      const activeAssessment = assessmentResponse.data?.find(
        (a) => a.status === "IN_PROGRESS",
      );

      if (!activeAssessment) {
        throw new Error("Aucune évaluation en cours trouvée");
      }
  ...
  // ============ Step 1 & 3: Fetch Batch (6 questions) ============
