    ...
    const types = [
        {
            ...
            metiers:
                'Mécanicien, électricien, agriculteur, ingénieur civil, architecte, technicien.',
        ...
        },
        {
            ...
            metiers:
                'Comptable, secrétaire, archiviste, contrôleur de gestion, analyste financier.',
        ...
        <div className="guide-riasec">
            ...
            <div className="guide-container">
                <section className="intro-section">
                    ...
                    <p>
                        Le RIASEC est un modèle développé par le psychologue américain John Holland.
                        Il classe les personnalités en <strong>6 grands types</strong> : Réaliste,
                        Investigateur, Artistique, Social, Entreprenant, Conventionnel. Chaque
                        personne possède une combinaison unique de ces types, avec un code à 3
                        lettres (ex: SAE) qui représente ses trois dominantes.
                    </p>
                    <p>
                        Ce modèle est utilisé dans le monde entier pour l'orientation scolaire et
                        professionnelle. Il permet de
                        <strong>
                            mettre en correspondance votre personnalité avec des métiers et des
                            formations
                        </strong>{' '}
                        adaptés.
                    </p>
                    ...
                    <div className="types-grid">
                        {types.map((type) => (
                            ...
                            >
                                ...
                                <p>
                                    <strong>Caractéristiques :</strong> {type.traits}
                                </p>
                                <p>
                                    <strong>Métiers typiques :</strong> {type.metiers}
                                </p>
                                <p>
                                    <strong>Filières associées :</strong> {type.filieres}
                                </p>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="steps-guide">
                        <div className="step-guide">
                            ...
                            <div>
                                ...
                                <p>
                                    Répondez aux questions adaptatives pour obtenir votre code à 3
                                    lettres (ex: SAI, REC...).
                                </p>
                            </div>
                        </div>
                        <div className="step-guide">
                            ...
                            <div>
                                ...
                                <p>
                                    Les deux premières lettres sont les plus importantes. Exemple :
                                    SAE = Social, Artistique, Entreprenant.
                                </p>
                            </div>
                        </div>
                        <div className="step-guide">
                            ...
                            <div>
                                ...
                                <p>
                                    Consultez notre moteur de recommandation pour voir la liste des
                                    métiers, filières et écoles adaptés.
                                </p>
                            </div>
                        </div>
                        <div className="step-guide">
                            ...
                            <div>
                                ...
                                <p>
                                    Ajoutez vos contraintes : budget, localisation, type
                                    d'établissement (public/privé).
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="examples">
                    ...
                    <div className="examples-grid">
                        <div className="example-card">
                            <strong>SAE</strong> (Social, Artistique, Entreprenant) → Communication,
                            marketing, événementiel.
                        </div>
                        <div className="example-card">
                            <strong>IRC</strong> (Investigateur, Réaliste, Conventionnel) →
                            Ingénierie, informatique, recherche.
                        </div>
                        <div className="example-card">
                            <strong>SEC</strong> (Social, Entreprenant, Conventionnel) → Gestion des
                            ressources humaines, enseignement, conseil.
                        </div>
                        <div className="example-card">
                            <strong>RAI</strong> (Réaliste, Artistique, Investigateur) →
                            Architecture, design produit, urbanisme.
                        </div>
                    </div>
                </section>
                ...
                <section className="advice">
                    ...
                    <ul>
                        <li>
                            <FontAwesomeIcon icon={faCheckCircle} /> Ne vous limitez pas aux métiers
                            « typiques » : la plupart des métiers combinent plusieurs types.
                        </li>
                        <li>
                            <FontAwesomeIcon icon={faCheckCircle} /> Votre profil peut évoluer avec
                            le temps et les expériences. Refaites le test chaque année.
                        </li>
                        <li>
                            <FontAwesomeIcon icon={faCheckCircle} /> Utilisez les recommandations
                            comme point de départ, puis explorez par vous-même.
                        </li>
                        <li>
                            <FontAwesomeIcon icon={faCheckCircle} /> Discutez avec des
                            professionnels des métiers qui vous intéressent.
                        </li>
                    </ul>
                </section>
                ...
                <div className="guide-cta">
                    ...
                    <Link to="/support" className="btn-back">
