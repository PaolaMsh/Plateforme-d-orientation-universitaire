...
const Scholarships = () => {
  ...
  const scholarships = [
    // Bourses spécifiques Bénin - Nouveautés
    {
      ...
      amount: "Complet",
      duration: "12-60 mois",
      coverage: ["Frais de scolarité", "Allocation mensuelle (900€)", "Billet d'avion aller-retour", "Assurance maladie", "Visa gratuit", "Logement en résidence universitaire"],
      requirements: [
      ...
      description: "Un programme d'excellence financé par les gouvernements français et béninois pour former les futurs cadres du Bénin dans les domaines prioritaires du développement.",
      rating: 4.9,
      applications: 450,
      deadlineDays: 42,
      languages: ["Français"],
      fields: ["Ingénierie", "Sciences", "Économie", "Droit", "Sciences politiques", "Médecine"],
    ...
    },
    {
      ...
      amount: "15,000€/an",
      duration: "24-48 mois",
      coverage: ["Frais de scolarité", "Allocation mensuelle (1,000€)", "Matériel artistique", "Billet d'avion", "Expositions et résidences artistiques"],
      requirements: [
      ...
      description: "Une bourse unique dédiée aux artistes béninois souhaitant se former dans les meilleures écoles d'art francophones. Soutenue par l'Organisation Internationale de la Francophonie.",
      rating: 4.8,
      applications: 120,
      deadlineDays: 57,
      languages: ["Français"],
      fields: ["Arts plastiques", "Design", "Mode", "Photographie", "Cinéma", "Théâtre", "Danse", "Musique"],
      beninPartnership: true,
      artistic: true
    },
    {
      ...
      amount: "Complet",
      duration: "12-48 mois",
      coverage: ["Frais de scolarité", "Logement sur campus", "Allocation mensuelle (2,500¥)", "Billet d'avion", "Cours de chinois", "Matériel artistique"],
      requirements: [
        "Artiste béninois",
      ...
      description: "Le gouvernement chinois offre des bourses spéciales pour les artistes béninois dans le cadre du partenariat culturel sino-béninois. Formation dans les meilleures académies d'art de Chine.",
      rating: 4.7,
      applications: 85,
      deadlineDays: 32,
      languages: ["Chinois", "Anglais"],
      fields: ["Calligraphie", "Peinture chinoise", "Céramique", "Design", "Animation", "Arts numériques"],
      beninPartnership: true,
      artistic: true
    },
    {
      ...
      duration: "24 mois",
      coverage: ["Frais de scolarité", "Allocation de subsistance", "Atelier d'artiste", "Billet d'avion", "Assurance santé", "Expositions"],
      requirements: [
      ...
      description: "Programme d'excellence pour les artistes béninois souhaitant développer leur pratique artistique dans un environnement créatif unique à Montréal, capitale culturelle du Québec.",
      rating: 4.9,
      applications: 95,
      deadlineDays: 74,
      languages: ["Français"],
      fields: ["Arts visuels", "Médias numériques", "Design graphique", "Scénographie", "Arts médiatiques"],
      beninPartnership: true,
      artistic: true
    },
    {
      ...
      amount: "1,500€/mois",
      duration: "12-24 mois",
      coverage: ["Frais de scolarité", "Allocation mensuelle", "Voyages inter-européens", "Résidences artistiques", "Expositions internationales"],
      requirements: [
      ...
      description: "Un programme unique permettant aux artistes béninois de voyager et d'étudier dans plusieurs pays européens tout en développant leur réseau artistique international.",
      rating: 4.8,
      applications: 150,
      deadlineDays: 72,
      languages: ["Anglais", "Français"],
      fields: ["Arts contemporains", "Performance", "Installation", "Art numérique", "Curating"],
      beninPartnership: true,
      artistic: true
    },
    {
      ...
      duration: "12-48 mois",
      coverage: ["Frais de scolarité", "Logement", "Allocation", "Transport local", "Matériel"],
      requirements: [
      ...
      description: "L'Union Africaine soutient les jeunes talents béninois dans les domaines artistiques, culturels et créatifs pour promouvoir la renaissance culturelle africaine.",
      rating: 4.7,
      applications: 200,
      deadlineDays: 118,
      languages: ["Français", "Anglais"],
      fields: ["Musique traditionnelle", "Danse africaine", "Théâtre engagé", "Cinéma documentaire", "Arts textiles", "Design produit"],
      beninPartnership: true,
      artistic: true
    },
    {
      ...
      amount: "Complet",
      duration: "12-60 mois",
      coverage: ["Frais de scolarité", "Logement", "Allocation mensuelle (3,000 MAD)", "Billet d'avion", "Assurance maladie"],
      requirements: [
      ...
      description: "Un programme de coopération entre le Maroc et le Bénin pour former des cadres supérieurs dans les domaines prioritaires du développement.",
      rating: 4.6,
      applications: 310,
      deadlineDays: 165,
      languages: ["Français", "Arabe"],
      fields: ["Agriculture", "Gestion de l'eau", "Énergies renouvelables", "Tourisme", "Hôtellerie", "Art culinaire"],
      beninPartnership: true
    },
    {
      id: 8,
      ...
      amount: "1,181 €/mois",
      duration: "12-36 mois",
      coverage: ["Frais de scolarité", "Allocation mensuelle", "Assurance maladie", "Billets d'avion"],
      requirements: [
      ...
      description: "La bourse Eiffel est un dispositif d'excellence qui permet de former de futurs décideurs étrangers dans les domaines prioritaires de la France.",
      rating: 4.8,
      applications: 1245,
      deadlineDays: 45,
      languages: ["Français", "Anglais"],
    ...
    },
    {
      ...
      description: "Le programme Chevening offre aux futurs leaders internationaux la possibilité d'étudier au Royaume-Uni.",
      rating: 4.9,
      applications: 2500,
      deadlineDays: 60,
      languages: ["Anglais"],
    ...
    },
    {
      ...
      amount: "934 €/mois",
      duration: "12-36 mois",
      coverage: ["Allocation mensuelle", "Assurance maladie", "Frais de voyage", "Cours d'allemand"],
      requirements: [
      ...
      description: "Les bourses DAAD soutiennent les étudiants internationaux souhaitant étudier en Allemagne, un pays leader dans la recherche et l'innovation.",
      rating: 4.7,
      applications: 1890,
      deadlineDays: 50,
    ...
    },
    {
      ...
      coverage: ["Frais académiques complets", "Logement", "Matériel informatique", "Transport", "Soutien psychosocial"],
      requirements: [
        "Étudiant africain",
        "Engagement communautaire",
        "Leadership démontré",
      ...
      description: "Un programme transformateur qui forme la prochaine génération de leaders africains capables de créer un changement social.",
      rating: 4.9,
      applications: 3200,
      deadlineDays: 35,
    ...
    },
    {
      ...
      amount: "Complet",
      duration: "12-48 mois",
      coverage: ["Frais de scolarité", "Logement", "Allocation mensuelle (800 TL)", "Billet d'avion", "Cours de turc"],
      requirements: [
        "Nationalité béninoise",
        "Moyenne minimale 70%",
      ...
      description: "Le gouvernement turc offre des bourses complètes aux étudiants béninois excellents dans tous les domaines, y compris les arts et la culture.",
      rating: 4.5,
      applications: 280,
      deadlineDays: 8,
      languages: ["Turc", "Anglais"],
      fields: ["Toutes disciplines", "Arts islamiques", "Musique ottomane", "Architecture", "Cinéma"],
      beninPartnership: true
    },
    {
      id: 13,
      ...
      amount: "147,000 ¥/mois",
      duration: "24-36 mois",
      coverage: ["Allocation mensuelle", "Frais de scolarité", "Billet d'avion", "Cours de japonais", "Matériel artistique"],
      requirements: [
        "Artiste béninois",
        "Portfolio exceptionnel",
        "Âge maximum: 35 ans",
      ...
      description: "Le gouvernement japonais offre des bourses aux artistes béninois talentueux pour étudier dans les meilleures écoles d'art du Japon.",
      rating: 4.9,
      applications: 60,
      deadlineDays: 37,
      languages: ["Japonais", "Anglais"],
      fields: ["Arts traditionnels japonais", "Manga", "Anime", "Design", "Photographie", "Céramique"],
      beninPartnership: true,
      artistic: true
    },
    {
      ...
      description: "Programme d'échanges pour les professionnels béninois souhaitant étudier en Amérique latine dans les domaines du développement et de la culture.",
      rating: 4.4,
      applications: 95,
      deadlineDays: 88,
      languages: ["Espagnol", "Portugais", "Anglais"],
      fields: ["Développement social", "Culture latino-américaine", "Musique", "Danse", "Cinéma", "Littérature"],
      beninPartnership: true
    },
    {
      id: 15,
      ...
      amount: "Complet",
      duration: "24 mois",
      coverage: ["Frais de scolarité", "Logement", "Allocation", "Studio d'artiste", "Expositions", "Réseautage"],
      requirements: [
      ...
      description: "Un programme prestigieux pour les artistes africains émergents, avec un focus sur la scène artistique contemporaine africaine.",
      rating: 4.8,
      applications: 110,
      deadlineDays: 133,
      languages: ["Anglais"],
      fields: ["Art contemporain africain", "Performance", "Installation", "Photographie documentaire", "Artivisme"],
      beninPartnership: true,
      artistic: true
    }
  ];
      ...
      <section className="scholarships-hero">
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <p>
              Découvrez les meilleures opportunités de bourses pour étudier à l'étranger.
              Financez vos études universitaires et réalisez votre rêve de mobilité internationale.
              <strong className="benin-highlight"> Nombreuses bourses en partenariat avec le Bénin !</strong>
            </p>
              ...
              >
                <div className="card-header">
                  <div className="card-badge">
                    <FontAwesomeIcon icon={scholarship.artistic ? faPalette : faAward} />
                ...
                <div className="card-content">
                  ...
                  <div className="rating">
                    <div className="stars">
                      {[...Array(5)].map((_, i) => (
                        <FontAwesomeIcon 
                          key={i}
                          icon={i < Math.floor(scholarship.rating) ? faStar : 
                                 i < scholarship.rating ? faStarHalfAlt : faStar}
                          className="star"
                        />
                      ))}
                      <span className="rating-value">{scholarship.rating}</span>
                    </div>
                  ...
                  <div className="fields-preview">
                    {scholarship.fields.slice(0, 3).map((field, i) => (
                      <span key={i} className="field-preview-tag">{field}</span>
                    ))}
                    {scholarship.fields.length > 3 && (
                      <span className="field-preview-tag more">+{scholarship.fields.length - 3}</span>
                    )}
                  </div>
                  ...
                  <div className="deadline">
                    <div className={`deadline-badge ${getDaysLeft(scholarship.deadline) <= 30 ? 'urgent' : ''}`}>
                      ...
                      <span>Date limite: {formatDate(scholarship.deadline)}</span>
                    </div>
      ...
      <div className="benin-special-section">
        <div className="container">
          <div className="benin-special-content">
            ...
            <p>
              Le Bénin a développé des partenariats stratégiques avec plusieurs pays pour offrir des bourses d'excellence 
              à ses étudiants. Profitez de ces opportunités uniques pour étudier à l'étranger dans des conditions optimales.
            </p>
      ...
      <div className="cta-section">
        <div className="container">
          <div className="cta-content">
            ...
            <p>Inscrivez-vous pour recevoir les dernières opportunités de bourses directement dans votre boîte mail</p>
