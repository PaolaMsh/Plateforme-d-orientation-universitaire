    ...
    <div className="contact-page">
      ...
      <div className="contact-container">
        <div className="contact-info">
          ...
          <div className="info-card">
            ...
            <div>
              <h3>Adresse</h3>
              <p>Cotonou, Bénin<br />Quartier Jéricho, 01 BP 1234</p>
            </div>
          </div>
          <div className="info-card">
            ...
            <div>
              <h3>Téléphone</h3>
              <p>+229 01 23 45 67<br />+229 98 76 54 32</p>
            </div>
          </div>
          <div className="info-card">
            ...
            <div>
              <h3>Email</h3>
              <p>contact@orientation-bj.bj<br />support@orientation-bj.bj</p>
            </div>
          </div>
          <div className="info-card">
            ...
            <div>
              <h3>Horaires</h3>
              <p>Lundi - Vendredi : 9h - 17h<br />Samedi : 9h - 13h</p>
            </div>
          </div>
        </div>
        ...
        <div className="contact-form-container">
          ...
          {submitSuccess && (
            <div className="alert success">
              <FontAwesomeIcon icon={faCheckCircle} /> Votre message a été envoyé avec succès. Nous vous répondrons dans les plus brefs délais.
            </div>
          )}
      ...
      <section className="faq-redirect">
        <div className="container">
          ...
          <p>Consultez notre centre d'aide et la FAQ pour obtenir rapidement une réponse.</p>
          <Link to="/support" className="btn-faq">Aller à la FAQ</Link>
        </div>
      </section>
    </div>
  );
